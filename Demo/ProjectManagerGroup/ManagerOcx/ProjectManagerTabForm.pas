...
uses
  ...
  ActiveX, AxCtrls, ManagerOcxLib_TLB, StdVcl, ComObj, ComServ,
  RTXCModulEinterfaceLib_TLB, RTXCAPILib_TLB, Vcl.StdCtrls{, RTXC.Event};

type
  TProjectManagerTab = class(TActiveForm, IProjectManagerTab)
    edt1: TEdit;
    chk1: TCheckBox;
    btn1: TButton;
  private
//    type
//        TRTXPluginTab = class(TAutoObject, IRTXPluginTab)
//        protected
//          function InitCtrl(const RtxRoot: IDispatch): HResult; stdcall;
//        end;
//
//        TRTXCPluginExtTabNotify = class(TAutoObject, IRTXCPluginExtTabNotify)
//        protected
...
//
//    FRTXCTabNofity: TRTXCPluginExtTabNotify;
//    FRTXCTab: TRTXPluginTab;
...
//    procedure DoOnInitCtrl(Sender: TObject; ARtxRoot: IRTXCRoot);
//    procedure DoOnEnterExtTab(Sender: TObject);
//    procedure DoOnLeaveExtTab(Sender: TObject);
  end;
...
// 插件的三个函数
//procedure TProjectManagerTab.DoOnInitCtrl(Sender: TObject; ARtxRoot: IRTXCRoot);
//begin
//  FRTXRoot := ARtxRoot;
//end;
//
//procedure TProjectManagerTab.DoOnLeaveExtTab(Sender: TObject);
//var
//  LRtxData: IRTXCData;
...
//end;
//
//procedure TProjectManagerTab.DoOnEnterExtTab(Sender: TObject);
//var
//  LRtxData: IRTXCData;
//  LEventCenter: IRTXCEventCenter;
//begin
...
procedure TProjectManagerTab.DoDestroy;
begin
  inherited;
//  FRTXCTabNofity.Free;
//  FRTXCTab.Free;
...
begin
  ...
  LHandle := Self.Parent.Handle;
  Self.Parent := nil;
  Windows.SetParent(Self.Handle, LHandle);
//  FRTXCTabNofity := TRTXCPluginExtTabNotify.Create;
//  FRTXCTabNofity.OnEnterExtTab := DoOnEnterExtTab;
//  FRTXCTabNofity.OnLeaveExtTab := DoOnLeaveExtTab;

//  FRTXCTab := TRTXPluginTab.Create;
//  FRTXCTab.OnInitCtrl := DoOnInitCtrl;
end;
...
{ TProjectManagerTab.TRTXPluginTab }

//function TProjectManagerTab.TRTXPluginTab.InitCtrl(
...
{ TProjectManagerTab.TRTXCPluginExtTabNotify }

//function TProjectManagerTab.TRTXCPluginExtTabNotify.EnterExtTab: HResult;
//var
//  LRtxData: IRTXCData;
//  LEventCenter: IRTXCEventCenter;
//begin
...
//function TProjectManagerTab.TRTXCPluginExtTabNotify.LeaveExtTab: HResult;
//var
//  LRtxData: IRTXCData;
//  LEventCenter: IRTXCEventCenter;
//begin
